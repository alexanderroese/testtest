...
import sty from "./PlasmicCaseStudiesWraper.module.css"; // plasmic-import: GNKMCOKKJJK0/css
    ...
    >
      {renderPlasmicSlot({
        defaultContents: (
          <PlasmicImg__
            alt={""}
            className={classNames(sty.img___9CiF)}
            displayHeight={"auto"}
        ...
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <Button
                className={classNames("__wab_instance", sty.button___5HLzh)}
                color={"blackCoffee"}
                submitsForm={true}
              >
                <div
