...
import sty from "./PlasmicHeader.module.css"; // plasmic-import: KVD776hCudP-/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__p6X7C)}>
            <PlasmicLink__
          ...
          <div className={classNames(projectcss.all, sty.column__eiEwt)}>
            <div
