...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: Cm-CggCqeV8Z/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___3Bo8E)}
      >
        {renderPlasmicSlot({
          defaultContents:
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__tFrg6)}
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__ko4J0)}
                displayHeight={"64px"}
              ...
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__tNe3J)}
              >
                <div className={classNames(projectcss.all, sty.freeBox__cmyff)}>
                  <h5
                    className={classNames(
                      projectcss.all,
                      projectcss.h5,
